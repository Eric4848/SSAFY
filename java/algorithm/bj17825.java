...
public class bj17825 {
	...
	public static void main(String[] args) throws IOException {
		...
		scores[1] = new int[] {10, 13, 16, 19};
		scores[2] = new int[] {20, 22, 24};
		scores[3] = new int[] {30, 28, 27, 26};
		scores[4] = new int[] {25, 30, 35, 40, 0};
		q = new LinkedList<>();
...
//				System.out.println("Start : "+ nline + ", " + piece.loc);
				...
				if(piece.line == 1 && 3 < nl) {
					nline = 4;
					nl -= 4;
				}
				if(piece.line == 2 && 2 < nl) {
					nline = 4;
					nl -= 3;
				}
				if(piece.line == 3 && 3 < nl) {
					nline = 4;
					nl -= 4;
				}
				if(nline == 4 && 3 < nl)
				...
				for(int k = 0; k < moved; k++) {
					...
					if(check.line == 4 && check.loc == 4) continue;
